...
module.exports = __webpack_require__.p + "78d64201079ccfec8f23dee48b024629.jpg";
...
((__t = (__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../assets/bg.jgp\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())))) == null ? '' : __t) +
'`" alt="">\n    <span>' +
((__t = ( layer.msg )) == null ? '' : __t) +
'</span>\n    ';
 for (let key in layer) { ;
__p += '\n        ' +
((__t = ( key )) == null ? '' : __t) +
' : ' +
((__t = ( JSON.stringify(layer[key]) )) == null ? '' : __t) +
'\n    ';
 } ;
__p += '\n</div>';
